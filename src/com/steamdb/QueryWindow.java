...
public class QueryWindow {
    ...
    private static final String resultOutput = "Questo è il risultato della ricerca:";
    private static final String namesBadlyFormatted =  "The variables set up by the designer do not match the naming convention";
    ...
    private Object getField(String name){
        ...
        try{
            ...
            System.err.println(namesBadlyFormatted + "or they can't be accessed");
            exit(1);
        }
        return field;
    }
